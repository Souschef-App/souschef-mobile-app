...
const StepComponent = ({style: styles}: any)  => {
    return(
        <VStack justifyContent={"flex-start"} style={styles.stepComponentWrapper} align={"center"} m={0} p={0} mall={new SpacingAll(0,0,0,0)} pall={new SpacingAll(0,0,0,0)}>
...
export const TaskBreakDownResultScreen = () => {
    ...
    return(
        <SafeArea>
            <VStack justifyContent={undefined} p={0} style={undefined} align={"center"} m={0} mall={new SpacingAll(0,0,0,0)} pall={new SpacingAll(0,0,0,0)}>
